...
def train_resNet(train_data_dir, validate_data_dir, categories, res_dir, model_file_name, weight_file_name,
                 img_width=224,
                 img_height=224):
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(
            '======== Split data into train / validate sets =========')  # Just because Keras 2.14 don't support this function.
